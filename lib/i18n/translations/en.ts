...
const en: TranslationDictionary = {
	...
	dashboard: {
		...
		recentPendingOwners: "Recent Pending Owners",
		noPendingOwners: "No pending owner registrations",
	...
	renters: {
		...
		accessCodePrompt: "Enter 6-digit access code to enter your dashboard",
		accessLocked: "Access code has been locked",
		tryAgainAfter: "try again after",
		saveCodePrompt: "Save this code for future login",
		important: "Important",
		registrationApprovalWarning:
			"Once the manager approves your registration, you must scan the flat's QR code and enter this 6-digit code to access. Write down this code or take a screenshot.",
		registrationSuccessTitle: "Registration Successful!",
		registrationSuccessDesc:
			"Your registration request has been submitted successfully. The building manager will review your request soon.",
		maintenanceWarning:
			"This flat is under maintenance. Registration is temporarily closed.",
		occupiedWarning: "This flat is occupied. New registration is not possible.",
		pendingRegistrationWarning:
			"A registration request is already pending for this flat.",
		...
		noPhoto: "No photo",
		utilityBillsLabel: "Utility Bills",
		noContractInfo: "No contract information found",
		member: "Member",
		digitalSignatureSignPrompt: "Sign with your finger here",
		selfiePhoto: "Selfie Photo (Required)",
		invalidCode: "Invalid access code",
		invalidCodeFormat: "Please enter a 6-digit access code",
		invalidSlug: "Invalid QR code",
		serverError: "Server error. Please try again.",
		lockoutMessage: "Too many incorrect attempts. Please try again later.",
	...
	maintenance: {
		...
		flat: "Flat",
		selectFlat: "Select a flat (optional)",
		status: "Status",
		renter: "Renter",
		createdAt: "Created",
	...
	issues: {
		...
		photoUpload: "Photo Attachments (optional)",
		assignedTo: "Assigned to",
		myIssues: "My Issues",
		submitReport: "Submit Report",
		newIssueReport: "Report a New Issue",
		noIssuesReported: "No issues have been reported.",
		titleMinLength: "Title must be at least 5 characters",
		descriptionMinLength: "Description must be at least 10 characters",
		...
		view: "View",
		issueListLoadError: "Could not load issue list",
	},
	notices: {
		title: "Notices",
		...
		expiresAtHint: "Leave empty if the notice never expires",
		expired: "Expired",
		active: "Active",
		archived: "Archived",
		...
		saveTemplateDescription: "Save this notice as a reusable template",
		templateName: "Template Name",
		templateNamePlaceholder: "e.g. Water Shutdown Notice",
		templateSaved: "Template saved successfully",
		templateSaveError: "Could not save template",
		templatesTitle: "Notice Templates",
	...
	adminOwners: {
		title: "Owner Registration Approvals",
		name: "Name",
		email: "Email",
		...
		rejected: "Rejected",
		allStatuses: "All Statuses",
		noOwners: "No owner registrations found",
		loadError: "Could not load owner registrations",
		approveSuccess: "Owner approved successfully",
		rejectSuccess: "Owner rejected successfully",
		approveError: "Failed to approve owner",
		rejectError: "Failed to reject owner",
		confirmApprove: "Are you sure you want to approve this owner?",
		confirmReject: "Are you sure you want to reject this owner?",
	},
	adminUsers: {
		...
		confirmDeactivate:
			"Are you sure you want to deactivate this user? This will invalidate all their sessions.",
	},
};
