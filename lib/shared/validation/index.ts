...
export const createMaintenanceRequestSchema = z.object({
	...
	buildingId: uuidSchema.optional(), // Made optional so Renter apps still work without it (backend sets it), but Manager apps should send it
	flatId: uuidSchema.optional().nullable(),
});
...
>;
export type ScheduleTerminationInput = z.infer<
	typeof scheduleTerminationSchema
>;
